...
class NginxConfig
{
    ...
    public function writeConfig()
    {
        ...
        $this->addConfigLine('} #EoLB')
                ...
                ->addConfigLine('access_log /var/log/turbine/' . $this->serverNameToFileName() . '.access.log;', 1)
                ->addConfigLine('error_log /var/log/turbine/' . $this->serverNameToFileName() . '.error.log;', 1)
                ->addBlankConfigLine()
